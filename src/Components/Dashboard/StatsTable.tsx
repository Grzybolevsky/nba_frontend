...
export const StatsTable: FunctionComponent<{ stats: Stats[] }> = ({ stats }) => {
  ...
  return (
    <Table>
      ...
      <TableBody>
        {stats.sort((n1, n2) => n2.pts - n1.pts).map(stat => (
          <TableRow key={stat.id}>
            <TableCell>{stat.player.first_name + ' ' + stat.player.last_name}</TableCell>
